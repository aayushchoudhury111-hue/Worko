      ...
      <section className="bg-gradient-to-r from-[#1f3b64] to-[#2b4f85] text-white px-10 py-16 grid md:grid-cols-2 gap-10 items-center md:text-left">
        <div>
          <h2 className="text-4xl font-extrabold flex items-center gap-3">
            <Zap className="text-yellow-400" /> Electrician
          </h2>
          <p className="mt-4 text-xl font-semibold">
            Tell us your electrical problem
          </p>
          <p className="mt-2 text-gray-200">
            Describe the issue so we can match you with the best electrician nearby.
          </p>
      ...
      <section className="px-10 py-16 grid md:grid-cols-3 gap-10">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 space-y-3">
            ...
            <p className="text-sm text-gray-500">1,250+ Ratings</p>
